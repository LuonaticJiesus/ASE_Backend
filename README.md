...
| comment_delete    | user_id(request.META自带)<br />comment_id                    |                  | 删除评论，级联删除其子评论                          | - 删除自己的评论<br />- 删除他人的评论，perm >=2 | 评论不存在<br />==删除他人评论时，==权限不足(pem<2)<br />~可删除自己发布的评论~ | `comment/delete/`    | POST           |
